...
export const templates: TicketTemplate[] = [
  {
    ...
    fields: {
      ...
      description: 'User is unable to sign in.\n\nAccount/service: \nError message: \nLast known successful login: \nTroubleshooting completed: ',
      category: 'Access',
  ...
  },
  {
    ...
    fields: {
      ...
      workNotes: 'Identity verification required before resetting the password.',
    },
  },
  {
    id: 'account-mfa',
    ...
    fields: {
      ...
      description: 'User is unable to complete MFA.\n\nAccount/service: \nMFA method: \nDevice available: \nExact error: \nTroubleshooting completed: ',
    },
  },
  {
    id: 'network',
  ...
  },
  {
    ...
    fields: {
      ...
      description: 'User cannot connect reliably to Wi-Fi.\n\nLocation: \nDevice/OS: \nNetwork name: \nSignal visible: \nExact error: \nOther networks affected: \nTroubleshooting completed: ',
    },
  },
  {
    id: 'network-vpn',
    ...
    fields: {
      ...
      subcategory: 'VPN',
      description: 'User cannot establish a VPN connection.\n\nLocation: \nDevice/OS: \nVPN client/version: \nExact error: \nHome internet working: \nTroubleshooting completed: ',
    },
  },
  {
    id: 'email',
    ...
    fields: {
      ...
      description: 'User reports an email issue.\n\nMail client/browser: \nDevice/OS: \nAffected mailbox: \nExact error: \nScope/other users: \nTroubleshooting completed: ',
      category: 'Email',
  ...
  },
  {
    ...
    fields: {
      ...
      description: 'Email was not delivered as expected.\n\nSender: \nRecipient: \nDate/time sent: \nSubject: \nNDR/error text: \nExternal or internal: \nTroubleshooting completed: ',
    },
  },
  {
    id: 'software',
    ...
    fields: {
      ...
      description: 'User reports a software issue.\n\nApplication/version: \nDevice/OS: \nExpected behavior: \nActual behavior/error: \nBusiness impact: \nTroubleshooting completed: ',
      category: 'Software',
  ...
  },
  {
    ...
    fields: {
      ...
      description: 'Software installation requested.\n\nApplication/version: \nDevice/asset tag: \nLicense available: \nBusiness justification: \nRequired by date: ',
    },
  },
  {
    id: 'hardware',
    ...
    fields: {
      ...
      description: 'User reports a hardware problem.\n\nDevice/asset tag: \nLocation: \nSymptoms: \nDamage observed: \nBusiness impact: \nTroubleshooting completed: ',
      category: 'Hardware',
      assignmentGroup: 'Endpoint Support',
      impact: '3 - Low',
      urgency: '3 - Low',
  ...
  },
  {
    ...
    fields: {
      ...
      description: 'External display or dock is not working.\n\nComputer/asset tag: \nDock model: \nMonitor model: \nConnection/cable: \nPower indicators: \nTroubleshooting completed: ',
    },
  },
  {
    id: 'security',
  ...
  },
  {
    ...
    fields: {
      ...
      description: 'Suspected phishing message reported.\n\nSender/address: \nSubject: \nDate/time received: \nLink clicked: No / Yes\nAttachment opened: No / Yes\nCredentials entered: No / Yes\nMessage attached to ticket: No / Yes',
    },
  },
  {
    id: 'general-request',
    title: 'General IT request',
    summary: 'Fallback intake for a request that does not fit another template.',
...
export function resolveTemplate(template: TicketTemplate): ResolvedTemplate {
  const parent = template.parentId ? byId.get(template.parentId) : undefined;
  return {
    ...template,
    parent,
    depth: parent ? 1 : 0,
    fields: parent ? { ...parent.fields, ...template.fields } : template.fields,
  };
}

export const resolvedTemplates = templates.map(resolveTemplate);
...
export function searchTemplates(query: string): ResolvedTemplate[] {
  ...
  return resolvedTemplates
    .map((template, index) => {
      ...
      const searchable = [template.title, template.parent?.title, template.summary, ...template.keywords]
        .filter(Boolean)
        .join(' ')
        .toLocaleLowerCase();
